...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <a href="/zettaiOpe/admin.php?s=/Home/SMChannel/add&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("sm_channel_add")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            <thead>
                <tr>
                    <th><?php echo (L("channel_id")); ?></th>
                    <th><?php echo (L("channel_name")); ?></th>
                    <th><?php echo (L("channel_code")); ?></th>
                    <th><?php echo (L("channel_callback")); ?></th>
            ...
            <tbody>
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <a href="/zettaiOpe/admin.php?s=/Home/SMChannel/status&id=<?php echo ($value["channel_id"]); ?>">[<?php echo (L("change")); ?>]</a>
                    </td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/SMChannel/edit&id=<?php echo ($value["channel_id"]); ?>"><?php echo (L("edit")); ?></a></td>
