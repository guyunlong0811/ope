...
<div class="page-content" style="min-height:648px !important">
    ...
    <div class="portlet-title">
        ...
        <a href="/zettaiOpe/admin.php?s=/Home/SMScript/add&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("sm_script_add")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            <thead>
                <tr>
                    <th><?php echo (L("server_id")); ?></th>
                    <th><?php echo (L("server_name")); ?></th>
                    <th><?php echo (L("server_link")); ?></th>
            ...
            <tbody>
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <a href="/zettaiOpe/admin.php?s=/Home/SMScript/status&id=<?php echo ($value["id"]); ?>">[<?php echo (L("change")); ?>]</a>
                    </td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/SMScript/delete&id=<?php echo ($value["id"]); ?>"><?php echo (L("delete")); ?></a></td>
