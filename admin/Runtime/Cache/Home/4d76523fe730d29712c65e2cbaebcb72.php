...
$(document).ready(function(){
    ...
    $("#name").val('');
    $("#server_id").val('<?php echo ($sid); ?>');
    $("#server_id").attr('disabled',true);

	$("#mainform").submit(function(){

        if($("#name").val() == ''){
            alert('<?php echo (L("server_name_input")); ?>');
            return false;
        }
            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="fa fa-code-fork"></i><?php echo (L("sm_server_open_channel")); ?></div>
                        ...
                        <form action="" method="POST" id="mainform" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control input-medium" id="server_id">
                                        ...
                                        <span class="help-block"><?php echo (L("server_type_input")); ?></span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo (L("server_name")); ?></label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="name" name="name" >
                                        <span class="help-block"><?php echo (L("server_name_input")); ?></span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo (L("sm_server_type")); ?></label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group" id="channel_radio">
                                    <label class="col-md-3 control-label"><?php echo (L("server_channel")); ?></label>
                                    <div class="col-md-9">
                                        ...
                                        <span class="help-block"><?php echo (L("server_channel_select")); ?></span>
                                    </div>
                                </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn" onclick="javascript:window.location.href='/zettaiOpe/admin.php?s=/Home/SMServer/channel&server_id=<?php echo ($vGet["server_id"]); ?>&search_channel_id=<?php echo ($vGet["search_channel_id"]); ?>&id=<?php echo ($vGet["id"]); ?>';"><i class="fa fa-undo"></i>&nbsp;<?php echo (L("return")); ?></button>
