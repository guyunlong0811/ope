...
<div class="page-content" style="min-height:648px !important">
    ...
    <a href="/zettaiOpe/admin.php?s=/Home/GMMarquee/send&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("gm_marquee_send")); ?></a>
                </div>
        </div>
        <div class="portlet-body">

    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
        <?php if(!empty($vTable)): ?><thead>
                <tr>
                    <th><?php echo (L("server")); ?></th>
                    <th><?php echo (L("content")); ?></th>
                    <th><?php echo (L("notice_level")); ?></th>
                    <th><?php echo (L("notice_endtime")); ?></th>
                    <th><?php echo (L("notice_interval")); ?></th>
                    <th><?php echo (L("result")); ?></th>
                    <th><?php echo (L("notice_ctime")); ?></th>
            ...
            <tbody>
                ...
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($value["result_name"]); ?></td>
                    <td><?php echo ($value["ctime"]); ?></td>
                    <?php switch($value["result"]): case "0": ?><td><a href="/zettaiOpe/admin.php?s=/Home/GMMarquee/resend&notice_id=<?php echo ($value["id"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("resend")); ?></a></td><?php break;?>
                        <?php case "2": ?><td><a href="/zettaiOpe/admin.php?s=/Home/GMMarquee/resend&notice_id=<?php echo ($value["id"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("resend")); ?></a></td><?php break;?>
                        <?php case "1": ?><td><a href="/zettaiOpe/admin.php?s=/Home/GMMarquee/cancel&notice_id=<?php echo ($value["id"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("cancel")); ?></a></td><?php break; endswitch;?>
