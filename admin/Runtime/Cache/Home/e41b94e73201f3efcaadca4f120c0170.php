...
<div class="page-content" style="min-height:648px !important">
    ...
    <div class="portlet-title">
        ...
        <a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupAdd" style="color:whitesmoke;"><?php echo (L("gm_pay_consume_group_add")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            <thead>
                <tr>
                    ...
                    <th><?php echo (L("activity_type")); ?>1</th>
                    <th><?php echo (L("activity_type")); ?>2</th>
                    <th><?php echo (L("activity_name")); ?></th>
                    <th><?php echo (L("starttime")); ?></th>
                    <th><?php echo (L("endtime")); ?></th>
                    <th colspan="6"><?php echo (L("operation")); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo (L("$value[type1_name]")); ?></td>
                    <td><?php echo (L("$value[type2_name]")); ?></td>
                    <td><?php echo ($value["name"]); ?></td>
                    <td><?php echo ($value["starttime"]); ?></td>
                    <td><?php echo ($value["endtime"]); ?></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupOpen&group=<?php echo ($value["group"]); ?>"><?php echo (L("status_all_active")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupClose&group=<?php echo ($value["group"]); ?>"><?php echo (L("status_all_banned")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupIndex&group=<?php echo ($value["group"]); ?>"><?php echo (L("detail")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupEdit&group=<?php echo ($value["group"]); ?>"><?php echo (L("edit")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupCopy&group=<?php echo ($value["group"]); ?>"><?php echo (L("copy")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/groupDelete&group=<?php echo ($value["group"]); ?>"><?php echo (L("delete")); ?></a></td>
