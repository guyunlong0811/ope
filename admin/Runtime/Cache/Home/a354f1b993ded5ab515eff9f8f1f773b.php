...
<div class="page-content" style="min-height:648px !important">
    ...
    <div class="portlet-title">
        ...
        <a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/add&group=<?php echo ($vGet["group"]); ?>" style="color:whitesmoke;"><?php echo (L("gm_pay_consume_add")); ?></a>
        |
        <a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/index" style="color:whitesmoke;"><<<?php echo (L("return")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            <thead>
                <tr>
                    <th><?php echo (L("activity_group_id")); ?></th>
                    <th><?php echo (L("activity_id")); ?></th>
                    <th><?php echo (L("activity_name")); ?></th>
                    <th><?php echo (L("activity_condition")); ?></th>
                    <th><?php echo (L("activity_max_complete")); ?></th>
                    <th><?php echo (L("platform_activity_id")); ?></th>
            ...
            <tbody>
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($value["receive_max"]); ?></td>
                        <td><?php echo ($value["pt_activity_id"]); ?></td>
                        <td>
                            <?php echo ($value["status"]); ?>
                            <a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/status&group=<?php echo ($value["group"]); ?>&id=<?php echo ($value["index"]); ?>">[<?php echo (L("change")); ?>]</a>
                        </td>
                        <td><a href="javascript:;" id="click<?php echo ($value["index"]); ?>"><?php echo (L("detail")); ?></a></td>
                        <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/edit&group=<?php echo ($value["group"]); ?>&id=<?php echo ($value["index"]); ?>"><?php echo (L("edit")); ?></a></td>
                        <td><a href="/zettaiOpe/admin.php?s=/Home/GMPayConsume/delete&group=<?php echo ($value["group"]); ?>&id=<?php echo ($value["index"]); ?>"><?php echo (L("delete")); ?></a></td>
                    </tr>

                    <tr id="detail<?php echo ($value["index"]); ?>" style="display:none;">
                        <td class="details" colspan="100%">
                            <table class="table table-bordered table-hover table-full-width">
                                <tbody>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>1</td>
                                        <td><?php echo ($value["bonus_1"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>2</td>
                                        <td><?php echo ($value["bonus_2"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>3</td>
                                        <td><?php echo ($value["bonus_3"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>4</td>
                                        <td><?php echo ($value["bonus_4"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>5</td>
                                        <td><?php echo ($value["bonus_5"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>6</td>
                                        <td><?php echo ($value["bonus_6"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>7</td>
                                        <td><?php echo ($value["bonus_7"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-2"><?php echo (L("activity_bonus")); ?>8</td>
                                        <td><?php echo ($value["bonus_8"]); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                    </tr>
                    <input type="hidden" id="switch<?php echo ($value["index"]); ?>" value="0" />
                    <script type="text/javascript">
                        $(document).ready(function(){
                            $("#click<?php echo ($value["index"]); ?>").click(function(){
                                if($("#switch<?php echo ($value["index"]); ?>").val() == '0'){
                                    $("#click<?php echo ($value["index"]); ?>").html('<?php echo (L("close")); ?>');
                                    $("#switch<?php echo ($value["index"]); ?>").val('1');
                                    $("#detail<?php echo ($value["index"]); ?>").show('fast');
                                }else{
                                    $("#click<?php echo ($value["index"]); ?>").html('<?php echo (L("detail")); ?>');
                                    $("#switch<?php echo ($value["index"]); ?>").val('0');
                                    $("#detail<?php echo ($value["index"]); ?>").hide('fast');
                                }
                            });
                        });
