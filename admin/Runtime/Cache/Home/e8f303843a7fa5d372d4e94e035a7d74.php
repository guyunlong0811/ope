...
<div class="page-content" style="min-height:648px !important">
    ...
    <a href="/zettaiOpe/admin.php?s=/Home/GMPush/send&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("gm_push_send")); ?></a>
                </div>
        </div>
    ...
    <table class="table table-striped table-bordered table-hover table-full-width">
        <thead>
            <tr>
                ...
                <th><?php echo (L("push_tid")); ?></th>
                <th><?php echo (L("push_msg")); ?></th>
                <th><?php echo (L("create_time")); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
