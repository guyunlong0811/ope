...
<div class="page-content" style="min-height:648px !important">
    ...
    <div class="container-fluid">
        ...
        <?php if(empty($vTable)): ?><div class="alert alert-danger">
...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <a href="/zettaiOpe/admin.php?s=/Home/Admin/add&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("admin_add")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            <thead>
                <tr>
                    <th><?php echo (L("admin_id")); ?></th>
                    <th><?php echo (L("admin_account")); ?></th>
                    <th><?php echo (L("admin_nickname")); ?></th>
                    <th><?php echo (L("admin_status")); ?></th>
            ...
            <tbody>
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="/zettaiOpe/admin.php?s=/Home/Admin/status&id=<?php echo ($value["uid"]); ?>&p=<?php echo ($pg); ?>"><?php echo ($value["status"]); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/Admin/edit&id=<?php echo ($value["uid"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("edit")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/Admin/permission&id=<?php echo ($value["uid"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("permission")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/Admin/server&id=<?php echo ($value["uid"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("server")); ?></a></td>
