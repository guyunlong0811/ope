...
<div class="page-content" style="min-height:648px !important">
    ...
    <a href="/zettaiOpe/admin.php?s=/Home/GMArenaRank/exchange&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("gm_arena_rank_exchange")); ?></a>
                </div>
        </div>
    ...
    <table class="table table-striped table-bordered table-hover table-full-width">
        <thead>
            <tr>
                ...
                <th><?php echo (L("rank_before")); ?></th>
                <th><?php echo (L("rank_after")); ?></th>
                <th><?php echo (L("create_time")); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if(!empty($vTable)): if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                <td><?php echo ($value["server"]); ?></td>
                <td><a href="/zettaiOpe/admin.php?s=/Home/UserInfo&server_id=<?php echo ($value["sid"]); ?>&team_id=<?php echo ($value["tid"]); ?>"><?php echo ($value["tid"]); ?></a></td>
