...
<div class="page-content" style="min-height:648px !important">
    ...
    <div class="portlet-title">
        ...
        <a href="/zettaiOpe/admin.php?s=/Home/GMNotice/add&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("gm_notice_add")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            <thead>
                <tr>
                    ...
                    <th><?php echo (L("notice_tab")); ?></th>
                    <th><?php echo (L("notice_title")); ?></th>
                    <th><?php echo (L("notice_hot")); ?></th>
                    <th><?php echo (L("priority")); ?></th>
                    <th><?php echo (L("starttime")); ?></th>
                    <th><?php echo (L("endtime")); ?></th>
                    <th><?php echo (L("ctime")); ?></th>
                    <th><?php echo (L("status")); ?></th>
                    <th colspan="2"><?php echo (L("operation")); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(is_array($vTable)): $i = 0; $__LIST__ = $vTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($value["tab"]); ?></td>
                    <td><?php echo ($value["title"]); ?></td>
                    <td><?php echo (L("$value[hot]")); ?></td>
                    ...
                    <td>
                        ...
                        <a href="/zettaiOpe/admin.php?s=/Home/GMNotice/status&p=<?php echo ($pg); ?>&id=<?php echo ($value["index"]); ?>">[<?php echo (L("change")); ?>]</a>
                    </td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMNotice/edit&p=<?php echo ($pg); ?>&id=<?php echo ($value["index"]); ?>"><?php echo (L("edit")); ?></a></td>
                    <td><a href="/zettaiOpe/admin.php?s=/Home/GMNotice/delete&p=<?php echo ($pg); ?>&id=<?php echo ($value["index"]); ?>"><?php echo (L("delete")); ?></a></td>
