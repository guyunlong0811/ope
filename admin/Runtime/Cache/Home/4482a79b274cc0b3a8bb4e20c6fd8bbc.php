...
<script type="text/javascript">
    $(document).ready(function() {
        <?php if(($super) == "1"): ?>$("input[type='checkbox']").attr("checked", true);
        <?php else: ?>
        <?php if(is_array($permission)): foreach($permission as $key=>$value): if(is_array($value)): foreach($value as $k=>$val): ?>$("input[id='<?php echo ($key); ?>.<?php echo ($val); ?>']").attr("checked", true);<?php endforeach; endif; endforeach; endif; endif; ?>
    });
</script>
            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="fa fa-lock"></i><?php echo (L("admin_permission")); ?></div>
                        ...
                        <form action="" method="POST" id="mainform" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="<?php echo ($data["username"]); ?>" disabled >
                                        <span class="help-block"><?php echo (L("not_allow_to_update")); ?></span>
                                    </div>
                                </div>

                                <?php if(is_array($vFunction)): foreach($vFunction as $key1=>$value1): ?><div class="form-group">
                                    <label class="col-md-3 control-label">
                                        <h4><?php echo ($value1["name"]); ?></h4>
                                    </label>
                                    <div class="col-md-9">
                                        <div class="input-group" style="padding-top:18px;">
                                            <a id="all_<?php echo ($key1); ?>" href="javascript:;"><?php echo (L("select_all")); ?></a>
                                            |
                                            <a id="none_<?php echo ($key1); ?>" href="javascript:;"><?php echo (L("select_none")); ?></a>
                                        </div>
                                    </div>
                                </div>

                                <?php if(is_array($value1["list"])): foreach($value1["list"] as $key2=>$value2): ?><div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo ($value2["name"]); ?></label>
                                    <div class="col-md-9">
                                        <div class="input-group checkbox_group_<?php echo ($key1); ?>">
                                            <?php if(is_array($value2["permission"])): foreach($value2["permission"] as $key3=>$value3): ?><label class="checkbox-inline">
                                                    <input type="checkbox" value="<?php echo ($value2["controller"]); ?>.<?php echo ($value3["action"]); ?>" id="<?php echo ($value2["controller"]); ?>.<?php echo ($value3["action"]); ?>" name="permission[]" class="module<?php echo ($key1); ?> <?php echo ($value2["controller"]); ?>" /><?php echo ($value3["name"]); ?>
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        $("#all_<?php echo ($key1); ?>").click(function(){
                                            $(".checkbox_group_<?php echo ($key1); ?> span").each(function(){
                                                $(this).attr('class', 'checked');
                                            });
                                            $(".module<?php echo ($key1); ?>").each(function(){
                                                $(this).attr('checked', true);
                                            });
                                        });
                                        $("#none_<?php echo ($key1); ?>").click(function(){
                                            $(".checkbox_group_<?php echo ($key1); ?> span").each(function(){
                                                $(this).attr('class', '');
                                            });
                                            $(".module<?php echo ($key1); ?>").each(function(){
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn" onclick="javascript:window.location.href='/zettaiOpe/admin.php?s=/Home/Admin&p=<?php echo ($pg); ?>';"><i class="fa fa-undo"></i>&nbsp;<?php echo (L("return")); ?></button>
