...
//CDN
define('CDN_SERVER_VERSION_HOST', '192.168.10.198');//多服务器用逗号','分割
define('CDN_SERVER_VERSION_USER', 'game');
define('CDN_SERVER_ZIP_HOST', '192.168.10.198');//多服务器用逗号','分割
define('CDN_SERVER_ZIP_USER', 'game');
define('CDN_SERVER_STATIC_HOST', '192.168.10.198');//多服务器用逗号','分割
