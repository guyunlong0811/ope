...
define('CDN_PATH_VERSION', '/usr/local/nginx/test1/');
define('CDN_PATH_ZIP', '/usr/local/nginx/test2/');
define('CDN_PATH_STATIC', '/usr/local/nginx/test3/');
define('CDN_PATH_LUA', '/usr/local/nginx/test3/');
